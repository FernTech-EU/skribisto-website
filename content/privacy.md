+++
title = "Privacy"
description = "This site sets no cookies, runs no analytics, and loads nothing from anyone else."
weight = 21
+++
...
Skribisto itself has no account system, no telemetry and no usage reporting. It does not phone home, and it does not need a network connection to open, edit, save or export your work. It makes exactly one network request, and only when you ask it to: fetching a spelling dictionary you chose to install.

Your manuscripts are files on your own machine. Nothing is uploaded anywhere.
