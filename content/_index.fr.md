...
cards = [
  { title = "La structure vient du sens", body = "L’arbre du classeur sert à ranger, et c’est tout ce qu’il fait. Ce qui fait d’une ligne un chapitre ou une scène, c’est le rôle que vous lui donnez — vous pouvez donc déplacer, indenter, désindenter et regrouper sans réécrire la forme du livre." },
