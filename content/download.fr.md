...
**Pour le savoir à ce moment-là** : suivez [le dépôt](https://github.com/jacquetc/skribisto) sur GitHub — les nouvelles versions vous seront notifiées — ou rejoignez [le Discord](https://discord.gg/5BSkvQmyVH), où cela sera dit en premier.
